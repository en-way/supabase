...
export default function MistakesPage() {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            <div className="flex items-center space-x-2">
              <h1 className="text-lg sm:text-xl font-bold text-zinc-900">历年真题错题研习库</h1>
              {isLoadingOnline && (
                <span className="flex items-center text-xs text-zinc-600 font-medium bg-zinc-100 px-2 py-0.5 rounded-full">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-black/[0.06] pb-3 no-print">
        ...
        <div className="flex items-center space-x-3 text-xs text-zinc-600">
          <div className="flex items-center space-x-1.5">
            ...
            <select
              ...
              className="text-xs bg-white border border-black/[0.06] rounded-lg px-2.5 py-1 text-zinc-800 outline-none shadow-subtle"
            >
